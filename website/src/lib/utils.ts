...
export const toolGroups = [
  { label: "Files", tools: ["read", "write", "edit", "replace", "glob", "grep", "tree", "patch", "diff"] },
  ...
  { label: "Meta-tooling", tools: ["tool_search", "tool_use", "batch_tool_use", "tool_help", "context_manager"] },
] as const
...
export const providerFamilies = [
  ...
  },
  {
    ...
    examples: ["Mistral", "Groq", "DeepSeek", "OpenRouter", "Together", "xAI", "Cerebras", "Ollama", "Fireworks", "Moonshot", "GLM", "Alibaba"],
  },
  {
    id: "google",
...
export const slashCommands = [
  "/init", "/help", "/clear", "/compact", "/context", "/diag", "/stats", "/usage",
  "/tools", "/skill", "/use", "/model", "/save", "/resume", "/plan", "/mode",
  "/yolo", "/autonomy", "/goal", "/spawn", "/fleet", "/agents", "/director",
  "/steer", "/queue", "/autophase", "/worktree", "/sdd", "/mcp", "/plugin",
  "/telegram", "/memory", "/metrics", "/health", "/commit", "/security",
  "/fix", "/image", "/altscreen", "/statusline",
] as const
