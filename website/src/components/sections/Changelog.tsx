    ...
    <section id="changelog" className="scroll-mt-20 border-t border-line bg-surface/40 py-20 sm:py-28">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          description="All notable changes tracked in CHANGELOG.md following Keep a Changelog. Lockstep versioning across 19 packages, 2 apps, and the marketing site."
        />
