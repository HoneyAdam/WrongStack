...
import type { MemoryAnchor, SuperMemory } from '../types.js';
 ...
 */
export function memoryQueryRelevance(memory: SuperMemory, query: string): MemoryQueryRelevance {
...
function structuralAnchorKeys(memory: SuperMemory): Set<string> {
