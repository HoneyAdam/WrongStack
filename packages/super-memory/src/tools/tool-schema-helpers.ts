...
export const KIND_VALUES: SuperMemoryKind[] = [
  'fact',
  'decision',
  'convention',
  'preference',
...
export const SCOPE_VALUES: SuperMemoryScope[] = ['project', 'user', 'session', 'file', 'symbol'];
export const STATUS_VALUES: SuperMemoryStatus[] = [
  'active',
  'stale',
  'superseded',
  'contradicted',
