...
const DEPS: readonly DependencyObservation[] = [
  { id: 'dep-1', workspaceId: 'ws-1', ecosystem: 'npm', name: 'express', sourceType: 'registry', direct: true, scope: 'runtime', locked: '4.18.2', latestStable: '4.19.0', status: 'update_available_safe', evidence: [] },
  { id: 'dep-2', workspaceId: 'ws-1', ecosystem: 'npm', name: 'lodash', sourceType: 'registry', direct: true, scope: 'runtime', locked: '4.17.20', latestStable: '4.17.21', status: 'current', evidence: [] },
  { id: 'dep-3', workspaceId: 'ws-1', ecosystem: 'npm', name: 'old-lib', sourceType: 'registry', direct: true, scope: 'runtime', locked: '1.0.0', latestStable: '3.0.0', status: 'update_available_breaking', evidence: [] },
  { id: 'dep-4', workspaceId: 'ws-1', ecosystem: 'python', name: 'requests', sourceType: 'registry', direct: true, scope: 'runtime', locked: '2.28.0', latestStable: '2.31.0', status: 'vulnerable', evidence: [] },
];

const FINDINGS: readonly Finding[] = [
  { id: 'f-1', dependencyId: 'dep-1', type: 'upgrade', severity: 'info', action: 'upgrade_minor', confidence: 1, rationale: 'A newer compatible version is available', evidence: [] },
  { id: 'f-2', dependencyId: 'dep-3', type: 'upgrade', severity: 'low', action: 'upgrade_major', confidence: 1, rationale: 'Major version available, may require breaking changes', breakingRisk: 'API changes in 3.x', evidence: [] },
  { id: 'f-3', dependencyId: 'dep-4', type: 'vulnerability', severity: 'high', action: 'upgrade_patch', confidence: 1, rationale: 'Security advisory: CVE-2023-1234', evidence: [] },
];
