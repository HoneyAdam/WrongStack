...
const TOGGLE_PANELS: Array<{ field: string; setState: (s: ReturnType<typeof baseState>) => void }> = [
  { field: 'monitorOpen', setState: (s) => { s.monitorOpen = true; } },
  { field: 'agentsMonitorOpen', setState: (s) => { s.agentsMonitorOpen = true; } },
  { field: 'helpOpen', setState: (s) => { s.helpOpen = true; } },
  { field: 'todosMonitorOpen', setState: (s) => { s.todosMonitorOpen = true; } },
  { field: 'queuePanelOpen', setState: (s) => { s.queuePanelOpen = true; } },
  { field: 'processListOpen', setState: (s) => { s.processListOpen = true; } },
  { field: 'cronMonitorOpen', setState: (s) => { s.cronMonitorOpen = true; } },
  { field: 'auditPanelOpen', setState: (s) => { s.auditPanelOpen = true; } },
  { field: 'planPanelOpen', setState: (s) => { s.planPanelOpen = true; } },
  { field: 'kanbanPanelOpen', setState: (s) => { s.kanbanPanelOpen = true; } },
  { field: 'goalPanelOpen', setState: (s) => { s.goalPanelOpen = true; } },
  { field: 'goalKanbanPanelOpen', setState: (s) => { s.goalKanbanPanelOpen = true; } },
  { field: 'contextPanelOpen', setState: (s) => { s.contextPanelOpen = true; } },
