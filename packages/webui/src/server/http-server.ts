...
async function handleApiSessionMessage(
  res: http.ServerResponse,
 ...
 */
async function handleApiSessionMailbox(
  res: http.ServerResponse,
  globalRoot: string | undefined,
  sessionId: string,
): Promise<void> {
 ...
 */
async function handleApiSessionInterrupt(
  res: http.ServerResponse,
  req: http.IncomingMessage,
  globalRoot: string | undefined,
  sessionId: string,
 ...
 */
async function handleApiFleetBroadcast(
  res: http.ServerResponse,
  req: http.IncomingMessage,
  globalRoot: string | undefined,
): Promise<void> {
