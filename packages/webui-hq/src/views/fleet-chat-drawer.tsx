...
import { setActiveView } from '../store.js';
...
export function FleetChatDrawer({
  ...
  return (
    <aside className="hq-fleet-drawer" role="dialog" aria-label={target.label}>
      <div className="hq-fleet-drawer-header">
        ...
        <span className="hq-fleet-drawer-title" title={target.label}>
          {target.label}
        </span>
        ...
        <span className="hq-fleet-drawer-actions">
          ...
          <button type="button" className="hq-btn secondary" onClick={onClose} aria-label="Close" title="Close (Esc)">
            <X size={13} />
          </button>
        </span>
      </div>
      ...
      <div className="hq-chat-scroll hq-fleet-drawer-body">
        ...
        {!chat.pinned && entries.length > 0 && (
          <button type="button" className="hq-chat-jump" onClick={chat.jumpToLatest} title="Jump to latest">
