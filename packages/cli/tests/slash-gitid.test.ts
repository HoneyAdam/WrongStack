...
import { configureChildEnvGitIdentity, getChildEnvGitIdentity, stripAnsi } from '@wrongstack/core';
...
describe('/gitid', () => {
  ...
  it('set persists identity to the global config and applies it', async () => {
